# Skoop Cricket 3D - Digital Signage App
...
- **Responsive Layout**: Optimized for various digital signage canvas sizes.
- **Offline Ready**: PWA support for reliable playback in signage environments.

## Tech Stack
- HTML5 / CSS3 (Glassmorphism, Flexbox, Keyframe Animations)
- JavaScript (ES6+)
...
## Deployment
The app is configured for production with cache-busting and no-cache meta tags to ensure the latest simulation logic is always active.
